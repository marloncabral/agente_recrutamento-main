...
if dados_ok:
    ...
    # Este bloco garante que todas as variáveis de memória existam
    ...
    with tab1:
        ...
        opcoes_vagas_ml = {row['codigo_vaga']: f"{row['titulo_vaga']} ({row['cliente']})" for _, row in df_vagas_ui.iterrows()}
